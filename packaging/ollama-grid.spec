...
cp -a sourcecuda-13-0-math-funcions.h.patch source/cuda_include
...
cp -a /source/ollama-grid/scripts/cuda-12-9-math-funcions.h.patch source/cuda_include-12.9/
pushd source/cuda_include
